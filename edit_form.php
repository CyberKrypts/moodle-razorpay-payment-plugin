 ...
 *
 * Adds new instance of enrol_razorpay to specified course
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_razorpay_edit_form extends moodleform {
    /**
     * Sets up moodle form.
     * @return void
     */
    public function definition() {
        ...
        $mform->addElement('header', 'header', get_string('pluginname', 'enrol_razorpay'));
        ...
        $mform->addElement('select', 'currency', get_string('currency', 'enrol_razorpay'), $stripecurrencies);
        ...
        $mform->addElement('text', 'customint3', get_string('maxenrolled', 'enrol_razorpay'));
        $mform->setDefault('maxenrolled', 'customint3');
        $mform->addHelpButton('customint3', 'maxenrolled', 'enrol_razorpay');
        $mform->setType('customint3', PARAM_INT);

        $mform->addElement('duration', 'enrolperiod', get_string('enrolperiod', 'enrol_razorpay'),
        array('optional' => true, 'defaultunit' => 86400));
        $mform->setDefault('enrolperiod', $plugin->get_config('enrolperiod'));
        $mform->addHelpButton('enrolperiod', 'enrolperiod', 'enrol_razorpay');

        $mform->addElement('date_time_selector', 'enrolstartdate', get_string('enrolstartdate', 'enrol_razorpay'),
        array('optional' => true));
        $mform->setDefault('enrolstartdate', 0);
        $mform->addHelpButton('enrolstartdate', 'enrolstartdate', 'enrol_razorpay');

        $mform->addElement('date_time_selector', 'enrolenddate', get_string('enrolenddate', 'enrol_razorpay'),
        array('optional' => true));
